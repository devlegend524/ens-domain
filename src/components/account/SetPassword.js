  ...
  return (
    <>
      <form onSubmit={handleSubmit}>
        <div className="pb-2 pl-2 text-gray-700 text-sm uppercase font-bold">
          Password
        </div>
        <div className="bg-gray-100 rounded-xl w-full text-center relative">
          <input
            ...
            ref={password}
            autoCapitalize="off"
            className="bg-transparent w-full placeholder:text-gray-400 text-black text-center p-4"
          />
        </div>
        <div className="pb-2 pl-2 center text-gray-700 text-sm uppercase mt-4 font-bold">
          Confirm Password
        </div>
        <div className="bg-gray-100 rounded-xl w-full text-center relative">
          <input
          ...
          {this.props.result ? (
            <>
              <components.labels.Success
                text={
                  "Your password has been set. You can now proceed with registering a domain."
                }
              />
            </>
          ) : (
...
const mapDispatchToProps = (dispatch) => ({
  setPassword: (token, password, passwordConfirm) =>
    dispatch(actions.setPassword(token, password, passwordConfirm)),
